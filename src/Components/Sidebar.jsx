  ...
  return (
    <div className='w-full bg-white pt-8 h-screen overflow-auto'>
                    ...
                    cartarray.map((e,i)=>{
                        ...
                        return(<>         
                            ...
                            <div className='flex gap-5'>
                                <div>
                                    <img className='w-25' src={e.proimg? e.proimg: ''} alt="" />
                                </div>
                                <div className='flex flex-col gap-1'>
                                    <h2 className='capitalize text-lg'>{e.prodname? e.prodname: ''} - {e.prodcolor}</h2>
                                    <h2>Size: {e.prodsize}</h2>
                                    <h2>${e.proprice}</h2>
        ...
        <div className='min-h-[300px] flex flex-col bg-[#F1F1F1] px-8 py-4'>
            ...
            <Link to={'/checkout'}><button className='w-full cursor-pointer h-12 border rounded bg-white'>CHECKOUT</button></Link>
