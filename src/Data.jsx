const Data = {
    ...
    dataarr: [
        ...
        {
            shoename: 'Leather cowboy',
            slug: 'Leather-cowboy',
            origionalprice: 89.00,
            discountedprice: 59.00,
            colors: [
                {colorname: 'Black', colorcode: '#000000'},
                {colorname: 'Brown', colorcode: '#836953'}
            ],
            size: [38, 39, 40, 41, 42],
            quantity: 1,
        ...
        {
            shoename: 'High heel platform',
            slug: "High-heel-platform",
            origionalprice: 56.00,
        ...
        {
            shoename: 'Platform cage sandals',
            slug: 'platform-cage-sandals',
            origionalprice: 56.00,
        ...
        {
            shoename: 'Flat track loafers',
            slug: 'Flat-track-loafers',
            origionalprice: 45.00,
            discountedprice: 29.00,
            colors: [
                {colorname: 'Beige', colorcode:' #E3DCCA'},
                {colorname: 'Black', colorcode: '#000000'},
                {colorname: 'White', colorcode: '#FFFFFF' }
            ],
            size: [38, 39, 40, 41, 42],
        ...
        {
            shoename: 'Platform trainers',
            slug: 'platform-trainers',
            origionalprice: 56.00,
            discountedprice: 39.00,
            colors: [
                {colorname: 'black', colorcode: '#000000'},
        ...
        {
            shoename: 'Stretch platform boots',
            slug: 'stretch-platform-boots',
            origionalprice: 69.00,
            discountedprice: 39.00,
            colors: [
                {colorname: 'Beige', colorcode: '#E3DCCA'},
                {colorname: 'Black', colorcode: '#000000'}
        ...
        {
            shoename: 'Strappy high heel',
            slug: 'strappy-high-heel',
            origionalprice: 45.00,
            discountedprice: 29.00,
            colors: [
                {colorname: 'black', colorcode: '#000000'},
